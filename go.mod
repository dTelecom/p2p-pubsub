...
require (
	...
	github.com/google/uuid v1.6.0 // Event ID generation
	github.com/libp2p/go-libp2p v0.42.0 // Latest libp2p networking
	github.com/libp2p/go-libp2p-kad-dht v0.33.1 // Latest Kademlia DHT
	github.com/libp2p/go-libp2p-pubsub v0.14.2 // Latest GossipSub
